import { GITHUB_REPO_URL, GITHUB_URL, LINKEDIN_URL, TWITTER_URL, MEDIUM_URL } from '../../lib/constants'

export function Footer() {
  return (
    <footer className="mt-16 mb-0 px-6 pb-5">
        ...
        <div className="flex flex-col items-center gap-4 text-sm text-muted-foreground">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 flex-wrap justify-center">
            <a
              ...
              className="text-primary hover:text-primary/80 transition-colors underline-offset-4 hover:underline flex items-center gap-1.5"
            >
              <GitHubIcon />
              View Source Code
            </a>
